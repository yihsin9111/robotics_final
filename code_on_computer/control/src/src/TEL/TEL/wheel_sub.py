...
class Wheel_sub(Node):
    ...
    def __init__(self, PWM_period = 5000, PWM_full = 100, PWM_zero = 0, PWM_factor = 1):
        ...
        self.left_backwheel_forward_pin = WHEEL_PIN.left_backwheel_RPWM
        self.left_backwheel_backward_pin = WHEEL_PIN.left_backwheel_LPWM
    
        self.right_backwheel_forward_pin = WHEEL_PIN.right_backwheel_LPWM
        self.right_backwheel_backward_pin = WHEEL_PIN.right_backwheel_RPWM
